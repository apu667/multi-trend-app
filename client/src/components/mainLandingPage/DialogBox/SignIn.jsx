      ...
      <DialogContent className="min-w-[780px] max-w-full p-0 overflow-hidden bg-black/60 backdrop-blur-xl border border-white/10 shadow-2xl rounded-3xl">
        <div className="flex flex-col md:flex-row h-full w-full">
          ...
          <div className="hidden md:flex flex-col justify-center items-center w-1/2 
                          bg-gradient-to-br from-purple-600 via-pink-500 to-blue-500 relative overflow-hidden rounded-l-3xl">
            ...
            <h2 className="text-4xl font-bold text-white drop-shadow-md z-10">Welcome Back ✨</h2>
            <p className="text-white/80 text-lg mt-2 z-10 text-center px-4">Login to continue</p>
          </div>

          {/* ---- RIGHT SIDE FORM ---- */}
          <form onSubmit={handleSubmit} className="w-full md:w-1/2 p-8 flex flex-col justify-center gap-6">
            <DialogHeader>
              <DialogTitle className="text-2xl font-semibold text-gray-300">Sign In</DialogTitle>
              ...
              <div className="grid gap-2">
                ...
                <Input
                  ...
                  className="bg-white/10 border border-white/20 text-white placeholder:text-gray-400 
                             focus:border-purple-500 focus:ring-2 focus:ring-purple-500 rounded-md transition"
                />
              </div>
            ...
            <DialogFooter className="mt-6 flex justify-between">
              <DialogClose asChild>
                <Button variant="outline" className="border-white/30 text-black hover:bg-white">
                  Cancel
                </Button>
              </DialogClose>

              <Button type="submit" className="bg-gradient-to-r from-purple-600 to-pink-600 text-white hover:opacity-90 shadow-lg px-6">
                Login
              </Button>
            </DialogFooter>
          </form>
